...
template <typename T>
requires std::is_default_constructible_v<T>
_EC_Const_Itr<T> EntityContainer<T>::begin() const
{
    return _EC_Const_Itr<T>(&m_data[0]);
}

template <typename T>
requires std::is_default_constructible_v<T>
_EC_Const_Itr<T> EntityContainer<T>::end() const
{
    return _EC_Const_Itr<T>(&m_data[m_size]);
}

template <typename T>
requires std::is_default_constructible_v<T>
_EC_Const_Itr<T> EntityContainer<T>::cbegin()
{
    return _EC_Const_Itr<T>(&m_data[0]);
}
...
template <typename T>
requires std::is_default_constructible_v<T>
_EC_Const_Itr<T> EntityContainer<T>::cend()
{
    return _EC_Const_Itr<T>(&m_data[m_size]);
}
