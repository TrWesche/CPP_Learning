...
void STD_MaxMin::execute() {
  ...
  std::cout << "======= std::ranges::max_element =======" << std::endl;
  ...
  std::vector<int>::iterator loc_max01 = std::ranges::max_element(
    vec_int01
  );
  ...
  std::deque<int>::iterator loc_max02 = std::ranges::min_element(
    deq_int02,
    distance
  );
  ...
  auto loc_min03 = std::ranges::min_element(
    arr_int03
  );
  ...
  print_collection_maxmin(arr_int03);
  auto[min_val, max_val] = std::ranges::minmax_element(
    arr_int03
  );
