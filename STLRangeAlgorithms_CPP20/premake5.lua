...
group "Dependencies"
    ...
    include "ProjectName/ext/CPP_Projection"
    include "ProjectName/ext/CPP_View"
group ""
...
LibraryObjDir["CPP_Projection"] = ("%{wks.location}/bin-int/" .. outputdir .. "/CPP_Projection")
LibraryObjDir["CPP_View"] = ("%{wks.location}/bin-int/" .. outputdir .. "/CPP_View")
...
LibraryTgtDir["Point"] = ("%{wks.location}/bin-int/" .. outputdir .. "/Point")
LibraryTgtDir["CPP_Projection"] = ("%{wks.location}/bin-int/" .. outputdir .. "/CPP_Projection")
LibraryTgtDir["CPP_View"] = ("%{wks.location}/bin-int/" .. outputdir .. "/CPP_View")
...
Library["CPP_Projection"] = "%{LibraryTgtDir.CPP_Projection}/CPP_Projection.lib"
Library["CPP_View"] = "%{LibraryTgtDir.CPP_View}/CPP_View.lib"
